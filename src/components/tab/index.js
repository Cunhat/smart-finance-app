   ...
   return (
      <div className="mainContainerTabs">
         <div className="tabsTitleContainer">
            <div className={selectedValue === 0 ? "tabSelectedItem" : "tabItem"} onClick={() => changeTabHandler(0)}>
               <FontAwesomeIcon icon={faUpload} className="iconTabs" />
               <span className="labelTabs">Upload file</span>
            </div>
            <div className={selectedValue === 1 ? "tabSelectedItem" : "tabItem"} onClick={() => changeTabHandler(1)}>
